...
function loadEffects(codigoCausa) {
    ...
    $.ajax({
        type: "POST",
        url: "GeneralManagement.aspx/ListEffects",
        data: obj,
...
function saveEffect() {
    ...
    $.ajax({
        type: "POST",
        url: "GeneralManagement.aspx/SaveEffect",
        data: obj,
        dataType: "json",
        contentType: 'application/json; charset=utf-8',
        error: function (xhr, ajaxOptions, thrownError) {
...
function updateEffect(id, descriptionA) {
    ...
    $.ajax({
        type: "POST",
        url: "GeneralManagement.aspx/UpdateEffect",
        data: obj,
        contentType: 'application/json; charset=utf-8',
        error: function (xhr, ajaxOptions, thrownError) {
            console.log(xhr.status + " \n" + xhr.responseText, "\n" + thrownError);
...
function deleteEffect(id) {
    ...
    $.ajax({
        type: "POST",
        url: "GeneralManagement.aspx/DeleteEffect",
        data: obj,
        contentType: 'application/json; charset=utf-8',
        error: function (xhr, ajaxOptions, thrownError) {
            console.log(xhr.status + " \n" + xhr.responseText, "\n" + thrownError);
