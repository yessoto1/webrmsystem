<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GeneralManagement.aspx.cs" Inherits="RmSystemWeb.GeneralManagement" %>
...
<body class="fix-header fix-sidebar card-no-border">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li><a class="has-arrow waves-effect waves-dark" aria-expanded="false" href="GeneralReportes.aspx">
                            <i class="fas fa-chart-line"></i><span class="hide-menu">Reportes</span></a>
                           
                        </li>
                        <li><a class="has-arrow waves-effect waves-dark" href="GeneralManagement.aspx" aria-expanded="false">
                            ...
                            <div class="p-20">
                                ...
                                <div class="row">
                                    <div class="col-sm-5 nopadding">
                                        ...
                                        <!-- debe habilitar los campos a editar -->
                                    </div>
                                    <div class="col-sm-7 nopadding">
                                        <div class="form-group">
                                            ...
                                            <!-- debe guardar datos y deshabilitar los campos a editar -->
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_tratar" role="tabpanel">
                            <div class="p-20">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7 nopadding">
                                        <div class="form-group">
                                            <label id="lblCodigoTratamiento"></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
    ...
    <script src="jscustom/Gcause.js"></script>
    <script src="jscustom/Gcharts.js"></script>
    <script src="jscustom/Gdetail.js"></script>
    <script src="jscustom/Geffect.js"></script>
    <script src="jscustom/Gimplement.js"></script>
    <script src="jscustom/Ginforme.js"></script>
    <script src="jscustom/Gproject.js"></script>
    <script src="jscustom/Grisk.js"></script>
    <script src="jscustom/Gtreatment.js"></script>
