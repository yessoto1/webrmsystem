...
function loadProjects() {
    $.ajax({
        type: "POST",
        url: "GeneralManagement.aspx/ListProjects",
        data: {},
...
function saveProject() {
    ...
    $.ajax({
        type: "POST",
        url: "GeneralManagement.aspx/SaveProject",
        data: obj,
        dataType: "json",
        contentType: 'application/json; charset=utf-8',
        error: function (xhr, ajaxOptions, thrownError) {
...
function deleteProyecto(id) {
    ...
    $.ajax({
        type: "POST",
        url: "GeneralManagement.aspx/DeleteProject",
        data: obj,
        contentType: 'application/json; charset=utf-8',
        error: function (xhr, ajaxOptions, thrownError) {
            console.log(xhr.status + " \n" + xhr.responseText, "\n" + thrownError);
...
function updateProject(id, nombre) {
    ...
    $.ajax({
        type: "POST",
        url: "GeneralManagement.aspx/UpdateProject",
        data: obj,
        dataType: "json",
        contentType: 'application/json; charset=utf-8',
        error: function (xhr, ajaxOptions, thrownError) {
